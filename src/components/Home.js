...
const Home = () => {
  ...
  return (
    <div className='w-full text-white flex  flex-col items-center justify-center mt-10 sm:gap-10 '>
        <div className='flex flex-col '>
          <div className='font-bold sm:text-[2rem] text-3xl mx-auto'>
            Welcome to <span className='sm:px-2 px-1 text-headingColor text-3xl sm:text-[2.5rem] font-cursive-style animate-pulse '>PenPalace</span>!!
          </div>
          <div className='text-start sm:text-[2rem] mx-auto flex text-lg items-center'>
            {text}  
            <Cursor cursorBlinking="false" cursorStyle="|" cursorColor='#4DCAF9'/>
          </div>
        </div>
        
        <div className='relative flex flex-col items-center justify-center px-3 mb-20'>
            <AllBlog size={5}/>
